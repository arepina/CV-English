...
\cventry
{
	...
	\begin{itemize}
		...
		\item Managed and educated team members. Leaded the knolwedge transfer for interns. Participated in the hiring process.
...
{Yandex FinTech / Back-end developer (Kotlin)} % Organization
{} % Location
...
{Deutsche bank / Associate Vice President / Full-stack developer (Java, C\# + TypeScript, React, Redux)} % Organization
{} % Location
{June 2019 - May 2023} % Date(s)	
\noindent	
